#dineña un codigo para obtener las raices de sinx+3cosx-2=0, dentro del intervalo [-2,2] ojo las raices son cercanas a 0.6 y 1.5, usando el metodo de la secante
...
x0 = 0.5  # Cerca de la primera raíz
x1 = 0.7  # Cerca de la primera raíz
raiz1 = secant_method(x0, x1)

# Para encontrar la segunda raíz, usar un nuevo intervalo que no incluya la primera raíz encontrada
if raiz1 is not None:
    if raiz1 < 1.5:
        x0 = raiz1 + 0.5  # Mover ligeramente el intervalo hacia la derecha
        x1 = 2.0
    else:
        x0 = -2.0
        x1 = raiz1 - 0.5  # Mover ligeramente el intervalo hacia la izquierda
